...
public class HoaDonPanel extends javax.swing.JPanel {
    ...
    private void exportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportActionPerformed
        ...
        if (Objects.equals(hoaDonRepository.findById(maHD).getTrangThai(), TrangThaiHoaDon.DA_HUY.getValue())) {

            JOptionPane.showMessageDialog(this, " không thể xuất hóa down đã bị hủy");
        ...
        if (exportInvoice == JOptionPane.YES_OPTION) {
            ...
            try {
                invoiceService.export(maHD, fileChooser.getSelectedFile().toString());
                JOptionPane.showMessageDialog(this, "Xuất hóa đơn " + maHD + " thành công");
            } catch (java.io.IOException e) {
                JOptionPane.showMessageDialog(this, "Xuất hóa đơn " + maHD + " thất bại");
            }
        }
